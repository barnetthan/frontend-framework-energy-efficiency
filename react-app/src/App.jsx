  ...
  return (
    <div className="app">
      ...
      <div className="control-panel">
        ...
        <button id="btn-sort" onClick={handleSort} disabled={rows.length === 0}>
          Sort by Price
        </button>
        <button onClick={handleFrequentUpdates} disabled={rows.length === 0}>
          Frequent Updates (10s)
        </button>
        <button id="btn-swap" onClick={handleSwap} disabled={rows.length === 0}>
          Swap All Rows
        </button>
        <button onClick={handlePartialUpdate} disabled={rows.length === 0}>
          Partial Update
        </button>
      </div>
